            ...
            <div className="w-full gap-12 flex flex-col max-w-3xl">
                ...
                <div className="rounded flex flex-col md:flex-row gap-2 justify-center items-center">
                    <div className="p-4 bg-gray-800/50 rounded flex flex-col items-center w-full gap-2">
                        <h1 className="bg-gradient-to-b from-sky-300 to-blue-400 text-transparent bg-clip-text font-mono text-5xl sm:text-6xl font-bold">{displayedStats.totalUsers}</h1>
                        <p className="font-mono text-left text-lg">Users</p>
                    </div>
                    <div className="p-4 bg-gray-800/50 rounded flex flex-col items-center w-full gap-2">
                        <h1 className="bg-gradient-to-b from-sky-300 to-blue-400 text-transparent bg-clip-text font-mono text-5xl sm:text-6xl font-bold">{displayedStats.totalViews}</h1>
                        <p className="font-mono text-left text-lg">Article Views</p>
                    </div>
                    <div className="p-4 bg-gray-800/50 rounded flex flex-col items-center w-full gap-2">
                        <h1 className="bg-gradient-to-b from-sky-300 to-blue-400 text-transparent bg-clip-text font-mono text-5xl sm:text-6xl font-bold">{displayedStats.totalHours}</h1>
